        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberGroup = table.Column<string>(type: "text", nullable: false),
                    NameUniversity = table.Column<string>(type: "text", nullable: false),
                    NumberRequest = table.Column<int>(type: "integer", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstName = table.Column<string>(type: "text", nullable: false),
                    MiddleName = table.Column<string>(type: "text", nullable: false),
                    NumberCourse = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Projects_XRef_Users", x => new { x.MembersId, x.ProjectsId });
                    table.ForeignKey(
